...
// CHECK-IR-RV64-LABEL: @test_mwmulu_mm_uint16m2(
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 128 x i16> @llvm.riscv.mwmulu.mm.nxv128i16.nxv128i8.i64(<vscale x 128 x i8> [[TMP1]], <vscale x 128 x i8> [[TMP3]], i64 0) #[[ATTR4]]
...
//
void test_mwmulu_mm_uint16m2(const uint8_t *in1, const uint8_t *in2, uint16_t *out, size_t a) {
    muint8_t m1 = mla_m(in1, a);
    muint8_t m2 = mla_m(in2, a);
    muint16m2_t mo = mwmulu_mm(m1, m2);
    msa_m(mo, out, a);
    return;
}

// CHECK-IR-RV64-LABEL: @test_mwmulu_mm_uint32m2(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 64 x i32> @llvm.riscv.mwmulu.mm.nxv64i32.nxv64i16.i64(<vscale x 64 x i16> [[TMP1]], <vscale x 64 x i16> [[TMP3]], i64 0) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mwmulu_mm_uint32m2(const uint16_t *in1, const uint16_t *in2, uint32_t *out, size_t a) {
    muint16_t m1 = mla_m(in1, a);
    muint16_t m2 = mla_m(in2, a);
    muint32m2_t mo = mwmulu_mm(m1, m2);
    msa_m(mo, out, a);
    return;
}

// CHECK-IR-RV64-LABEL: @test_mwmulu_mm_uint64m2(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 32 x i64> @llvm.riscv.mwmulu.mm.nxv32i64.nxv32i32.i64(<vscale x 32 x i32> [[TMP1]], <vscale x 32 x i32> [[TMP3]], i64 0) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mwmulu_mm_uint64m2(const uint32_t *in1, const uint32_t *in2, uint64_t *out, size_t a) {
    muint32_t m1 = mla_m(in1, a);
    muint32_t m2 = mla_m(in2, a);
    muint64m2_t mo = mwmulu_mm(m1, m2);
    msa_m(mo, out, a);
    return;
}
