...
// CHECK-IR-RV64-LABEL: @test_mfwsub_mm_float32(
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 32 x float> @llvm.riscv.mfwsub.mm.nxv32f32.nxv64f16(<vscale x 64 x half> [[TMP1]], <vscale x 64 x half> [[TMP3]]) #[[ATTR4]]
...
//
void test_mfwsub_mm_float32(const _Float16 *in1, const _Float16 *in2, float *out, size_t a) {
    mfloat16_t m1 = mlc_m(in1, a);
    mfloat16_t m2 = mlc_m(in2, a);
    mfloat32_t mo = mfwsub_mm(m1, m2);
    msc_m(mo, out, a);
    return;
}

// CHECK-IR-RV64-LABEL: @test_mfwsub_mm_float64(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 16 x double> @llvm.riscv.mfwsub.mm.nxv16f64.nxv32f32(<vscale x 32 x float> [[TMP1]], <vscale x 32 x float> [[TMP3]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mfwsub_mm_float64(const float *in1, const float *in2, double *out, size_t a) {
    mfloat32_t m1 = mlc_m(in1, a);
    mfloat32_t m2 = mlc_m(in2, a);
    mfloat64_t mo = mfwsub_mm(m1, m2);
    msc_m(mo, out, a);
    return;
}
