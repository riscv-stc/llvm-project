...
// CHECK-IR-RV64-LABEL: @test_msadd_mm_int8m1(
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 128 x i8> @llvm.riscv.msadd.mm.nxv128i8.i64(<vscale x 128 x i8> [[TMP1]], <vscale x 128 x i8> [[TMP3]], i64 0) #[[ATTR4]]
...
//
void test_msadd_mm_int8m1(const int8_t *in1, const int8_t *in2, int8_t *out, size_t a) {
    mint8m1_t m1 = mlae8_m1(in1, a);
    mint8m1_t m2 = mlae8_m1(in2, a);
    mint8m1_t mo = msadd_mm(m1, m2);
    msae8_m(mo, out, a);
    return;
}

// CHECK-IR-RV64-LABEL: @test_msadd_mm_int16m1(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 64 x i16> @llvm.riscv.msadd.mm.nxv64i16.i64(<vscale x 64 x i16> [[TMP1]], <vscale x 64 x i16> [[TMP3]], i64 0) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_msadd_mm_int16m1(const int16_t *in1, const int16_t *in2, int16_t *out, size_t a) {
    mint16m1_t m1 = mlae16_m1(in1, a);
    mint16m1_t m2 = mlae16_m1(in2, a);
    mint16m1_t mo = msadd_mm(m1, m2);
    msae16_m(mo, out, a);
    return;
}

// CHECK-IR-RV64-LABEL: @test_msadd_mm_int32m1(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 32 x i32> @llvm.riscv.msadd.mm.nxv32i32.i64(<vscale x 32 x i32> [[TMP1]], <vscale x 32 x i32> [[TMP3]], i64 0) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_msadd_mm_int32m1(const int32_t *in1, const int32_t *in2, int32_t *out, size_t a) {
    mint32m1_t m1 = mlae32_m1(in1, a);
    mint32m1_t m2 = mlae32_m1(in2, a);
    mint32m1_t mo = msadd_mm(m1, m2);
    msae32_m(mo, out, a);
    return;
}

// CHECK-IR-RV64-LABEL: @test_msadd_mm_int64m1(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 16 x i64> @llvm.riscv.msadd.mm.nxv16i64.i64(<vscale x 16 x i64> [[TMP1]], <vscale x 16 x i64> [[TMP3]], i64 0) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_msadd_mm_int64m1(const int64_t *in1, const int64_t *in2, int64_t *out, size_t a) {
    mint64m1_t m1 = mlae64_m1(in1, a);
    mint64m1_t m2 = mlae64_m1(in2, a);
    mint64m1_t mo = msadd_mm(m1, m2);
    msae64_m(mo, out, a);
    return;
}
