...
// CHECK-IR-RV64-LABEL: @test_mwma_int32(
...
// CHECK-IR-RV64-NEXT:    [[TMP6:%.*]] = call <vscale x 32 x i32> @llvm.riscv.mwma.mm.nxv32i32.nxv64i16(<vscale x 32 x i32> [[TMP5]], <vscale x 64 x i16> [[TMP1]], <vscale x 64 x i16> [[TMP3]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP7:%.*]] = call <vscale x 32 x i32> @llvm.riscv.mwma.h.mm.nxv32i32.nxv64i16(<vscale x 32 x i32> [[TMP6]], <vscale x 64 x i16> [[TMP1]], <vscale x 64 x i16> [[TMP3]]) #[[ATTR4]]
...
//
void test_mwma_int32(const int32_t *dest, const int16_t *in1,
                      const int16_t *in2, size_t a) {
    mint16_t m1 = mla_m(in1, a);
    mint16_t m2 = mla_m(in2, a);
    mint32_t d_m = mlc_m(dest, a);
    d_m = mwma_mm(d_m, m1, m2);
    d_m = mwma_h_mm(d_m, m1, m2);
    msc_m(d_m, dest, a);
    return;
}

// CHECK-IR-RV64-LABEL: @test_mwma_int64(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP6:%.*]] = call <vscale x 16 x i64> @llvm.riscv.mwma.mm.nxv16i64.nxv32i32(<vscale x 16 x i64> [[TMP5]], <vscale x 32 x i32> [[TMP1]], <vscale x 32 x i32> [[TMP3]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP7:%.*]] = call <vscale x 16 x i64> @llvm.riscv.mwma.w.mm.nxv16i64.nxv32i32(<vscale x 16 x i64> [[TMP6]], <vscale x 32 x i32> [[TMP1]], <vscale x 32 x i32> [[TMP3]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mwma_int64(const int64_t *dest, const int32_t *in1,
                      const int32_t *in2, size_t a) {
    mint32_t m1 = mla_m(in1, a);
    mint32_t m2 = mla_m(in2, a);
    mint64_t d_m = mlc_m(dest, a);
    d_m = mwma_mm(d_m, m1, m2);
    d_m = mwma_w_mm(d_m, m1, m2);
    msc_m(d_m, dest, a);
    return;
}

// CHECK-IR-RV64-LABEL: @test_mqma_int32(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = bitcast i32* [[DEST:%.*]] to <vscale x 32 x i32>*
// CHECK-IR-RV64-NEXT:    [[TMP5:%.*]] = call <vscale x 32 x i32> @llvm.riscv.mlc.m.nxv32i32.i64(<vscale x 32 x i32>* [[TMP4]], i64 [[A]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP6:%.*]] = call <vscale x 32 x i32> @llvm.riscv.mqma.mm.nxv32i32.nxv128i8(<vscale x 32 x i32> [[TMP5]], <vscale x 128 x i8> [[TMP1]], <vscale x 128 x i8> [[TMP3]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP7:%.*]] = call <vscale x 32 x i32> @llvm.riscv.mqma.b.mm.nxv32i32.nxv128i8(<vscale x 32 x i32> [[TMP6]], <vscale x 128 x i8> [[TMP1]], <vscale x 128 x i8> [[TMP3]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP8:%.*]] = bitcast i32* [[DEST]] to <vscale x 32 x i32>*
// CHECK-IR-RV64-NEXT:    call void @llvm.riscv.msc.m.nxv32i32.i64(<vscale x 32 x i32> [[TMP7]], <vscale x 32 x i32>* [[TMP8]], i64 [[A]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mqma_int32(const int32_t *dest, const int8_t *in1,
                      const int8_t *in2, size_t a) {
    mint8_t m1 = mla_m(in1, a);
    mint8_t m2 = mla_m(in2, a);
    mint32_t d_m = mlc_m(dest, a);
    d_m = mqma_mm(d_m, m1, m2);
    d_m = mqma_b_mm(d_m, m1, m2);
    msc_m(d_m, dest, a);
    return;
}
