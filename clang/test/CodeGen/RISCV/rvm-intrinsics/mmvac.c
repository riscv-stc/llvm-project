...
void test_mmvac_m_v_mfloat16_m1(const _Float16 *in1, _Float16 *out, size_t a) {
    ...
    mfloat16m1_t v1 = mmvac_m_v(m1, a);
    msae16_m(v1, out, a);
    return;
}
...
void test_mmvac_m_v_mfloat32_m1(const float *in1, float *out, size_t a) {
    ...
    mfloat32m1_t v1 = mmvac_m_v(m1, a);
    msae32_m(v1, out, a);
    return;
}
