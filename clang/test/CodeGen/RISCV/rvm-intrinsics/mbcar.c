...
// CHECK-IR-RV64-LABEL: @test_mbcar_m_mint8_m1(
...
// CHECK-IR-RV64-NEXT:    [[TMP2:%.*]] = call <vscale x 128 x i8> @llvm.riscv.mbcar.m.nxv128i8(<vscale x 128 x i8> [[TMP1]]) #[[ATTR4]]
...
//
void test_mbcar_m_mint8_m1(const int8_t *in1, int8_t *out, size_t a) {
...
// CHECK-IR-RV64-LABEL: @test_mbcar_m_muint8_m1(
// CHECK-IR-RV64-NEXT:  entry:
// CHECK-IR-RV64-NEXT:    [[TMP0:%.*]] = bitcast i8* [[IN1:%.*]] to <vscale x 128 x i8>*
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mbcar_m_muint8_m1(const uint8_t *in1, uint8_t *out, size_t a) {
...
// CHECK-IR-RV64-LABEL: @test_mbcar_m_mint16_m1(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP2:%.*]] = call <vscale x 64 x i16> @llvm.riscv.mbcar.m.nxv64i16(<vscale x 64 x i16> [[TMP1]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mbcar_m_mint16_m1(const int16_t *in1, int16_t *out, size_t a) {
...
// CHECK-IR-RV64-LABEL: @test_mbcar_m_muint16_m1(
// CHECK-IR-RV64-NEXT:  entry:
// CHECK-IR-RV64-NEXT:    [[TMP0:%.*]] = bitcast i16* [[IN1:%.*]] to <vscale x 64 x i16>*
// CHECK-IR-RV64-NEXT:    [[TMP1:%.*]] = call <vscale x 64 x i16> @llvm.riscv.mla.m.nxv64i16.i64(<vscale x 64 x i16>* [[TMP0]], i64 [[A:%.*]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP2:%.*]] = call <vscale x 64 x i16> @llvm.riscv.mbcar.m.nxv64i16(<vscale x 64 x i16> [[TMP1]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mbcar_m_muint16_m1(const uint16_t *in1, uint16_t *out, size_t a) {
...
// CHECK-IR-RV64-LABEL: @test_mbcar_m_mint32_m1(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP2:%.*]] = call <vscale x 32 x i32> @llvm.riscv.mbcar.m.nxv32i32(<vscale x 32 x i32> [[TMP1]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mbcar_m_mint32_m1(const int32_t *in1, int32_t *out, size_t a) {
...
// CHECK-IR-RV64-LABEL: @test_mbcar_m_muint32_m1(
// CHECK-IR-RV64-NEXT:  entry:
// CHECK-IR-RV64-NEXT:    [[TMP0:%.*]] = bitcast i32* [[IN1:%.*]] to <vscale x 32 x i32>*
// CHECK-IR-RV64-NEXT:    [[TMP1:%.*]] = call <vscale x 32 x i32> @llvm.riscv.mla.m.nxv32i32.i64(<vscale x 32 x i32>* [[TMP0]], i64 [[A:%.*]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP2:%.*]] = call <vscale x 32 x i32> @llvm.riscv.mbcar.m.nxv32i32(<vscale x 32 x i32> [[TMP1]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mbcar_m_muint32_m1(const uint32_t *in1, uint32_t *out, size_t a) {
...
// CHECK-IR-RV64-LABEL: @test_mbcar_m_mint64_m1(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP2:%.*]] = call <vscale x 16 x i64> @llvm.riscv.mbcar.m.nxv16i64(<vscale x 16 x i64> [[TMP1]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mbcar_m_mint64_m1(const int64_t *in1, int64_t *out, size_t a) {
...
// CHECK-IR-RV64-LABEL: @test_mbcar_m_muint64_m1(
// CHECK-IR-RV64-NEXT:  entry:
// CHECK-IR-RV64-NEXT:    [[TMP0:%.*]] = bitcast i64* [[IN1:%.*]] to <vscale x 16 x i64>*
// CHECK-IR-RV64-NEXT:    [[TMP1:%.*]] = call <vscale x 16 x i64> @llvm.riscv.mla.m.nxv16i64.i64(<vscale x 16 x i64>* [[TMP0]], i64 [[A:%.*]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP2:%.*]] = call <vscale x 16 x i64> @llvm.riscv.mbcar.m.nxv16i64(<vscale x 16 x i64> [[TMP1]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mbcar_m_muint64_m1(const uint64_t *in1, uint64_t *out, size_t a) {
...
// CHECK-IR-RV64-LABEL: @test_mbcar_m_mfloat16_m1(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP2:%.*]] = call <vscale x 64 x half> @llvm.riscv.mbcar.m.nxv64f16(<vscale x 64 x half> [[TMP1]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mbcar_m_mfloat16_m1(const _Float16 *in1, _Float16 *out, size_t a) {
...
// CHECK-IR-RV64-LABEL: @test_mbcar_m_mfloat32_m1(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP2:%.*]] = call <vscale x 32 x float> @llvm.riscv.mbcar.m.nxv32f32(<vscale x 32 x float> [[TMP1]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mbcar_m_mfloat32_m1(const float *in1, float *out, size_t a) {
...
// CHECK-IR-RV64-LABEL: @test_mbcar_m_mfloat64_m1(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP2:%.*]] = call <vscale x 16 x double> @llvm.riscv.mbcar.m.nxv16f64(<vscale x 16 x double> [[TMP1]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mbcar_m_mfloat64_m1(const double *in1, double *out, size_t a) {
