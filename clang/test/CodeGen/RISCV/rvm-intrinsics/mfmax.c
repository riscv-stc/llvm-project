...
// CHECK-IR-RV64-LABEL: @test_mfmax_mm_float16m1(
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 64 x half> @llvm.riscv.mfmax.mm.nxv64f16.i64(<vscale x 64 x half> [[TMP1]], <vscale x 64 x half> [[TMP3]], i64 0) #[[ATTR4]]
...
//
void test_mfmax_mm_float16m1(const _Float16 *in1, const _Float16 *in2, _Float16 *out, size_t a) {
    mfloat16m1_t m1 = mlae16_m1(in1, a);
    mfloat16m1_t m2 = mlae16_m1(in2, a);
    mfloat16m1_t mo = mfmax_mm(m1, m2);
    msae16_m(mo, out, a);
    return;
}

// CHECK-IR-RV64-LABEL: @test_mfmax_mm_float32m1(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 32 x float> @llvm.riscv.mfmax.mm.nxv32f32.i64(<vscale x 32 x float> [[TMP1]], <vscale x 32 x float> [[TMP3]], i64 0) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mfmax_mm_float32m1(const float *in1, const float *in2, float *out, size_t a) {
    mfloat32m1_t m1 = mlae32_m1(in1, a);
    mfloat32m1_t m2 = mlae32_m1(in2, a);
    mfloat32m1_t mo = mfmax_mm(m1, m2);
    msae32_m(mo, out, a);
    return;
}

// CHECK-IR-RV64-LABEL: @test_mfmax_mm_float64m1(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 16 x double> @llvm.riscv.mfmax.mm.nxv16f64.i64(<vscale x 16 x double> [[TMP1]], <vscale x 16 x double> [[TMP3]], i64 0) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mfmax_mm_float64m1(const double *in1, const double *in2, double *out, size_t a) {
    mfloat64m1_t m1 = mlae64_m1(in1, a);
    mfloat64m1_t m2 = mlae64_m1(in2, a);
    mfloat64m1_t mo = mfmax_mm(m1, m2);
    msae64_m(mo, out, a);
    return;
}
