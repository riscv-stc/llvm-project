...
// CHECK-IR-RV64-LABEL: @test_mfmv_s_f_mfloat16_m1(
...
// CHECK-IR-RV64-NEXT:    [[TMP2:%.*]] = call <vscale x 64 x half> @llvm.riscv.mfmv.s.f.nxv64f16.f16.i64(<vscale x 64 x half> [[TMP1]], half 0xH4500, i64 [[A]]) #[[ATTR4]]
...
//
void test_mfmv_s_f_mfloat16_m1(const _Float16 *in1, _Float16 *out, size_t a) {
    mfloat16m1_t m1 = mlae16_m1(in1, a);
    m1 = mfmv_s_f(m1, 5.0, a);
    msae16_m(m1, out, a);
    return;
}
...
// CHECK-IR-RV64-NEXT:    [[TMP2:%.*]] = call <vscale x 32 x float> @llvm.riscv.mfmv.s.f.nxv32f32.f32.i64(<vscale x 32 x float> [[TMP1]], float 5.000000e+00, i64 [[A]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mfmv_s_f_mfloat32_m1(const float *in1, float *out, size_t a) {
...
// CHECK-IR-RV64-LABEL: @test_mfmv_s_f_mfloat64_m1(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP2:%.*]] = call <vscale x 16 x double> @llvm.riscv.mfmv.s.f.nxv16f64.f64.i64(<vscale x 16 x double> [[TMP1]], double 5.000000e+00, i64 [[A]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mfmv_s_f_mfloat64_m1(const double *in1, double *out, size_t a) {
...
// CHECK-IR-RV64-LABEL: @test_mfmv_f_s_mfloat16_m1(
// CHECK-IR-RV64-NEXT:  entry:
// CHECK-IR-RV64-NEXT:    [[TMP0:%.*]] = bitcast half* [[IN1:%.*]] to <vscale x 64 x half>*
// CHECK-IR-RV64-NEXT:    [[TMP1:%.*]] = call <vscale x 64 x half> @llvm.riscv.mlae.m.nxv64f16.i64(<vscale x 64 x half>* [[TMP0]], i64 [[A:%.*]], i64 0) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP2:%.*]] = call half @llvm.riscv.mfmv.f.s.f16.nxv64f16.i64(<vscale x 64 x half> [[TMP1]], i64 [[A]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    ret half [[TMP2]]
//
_Float16 test_mfmv_f_s_mfloat16_m1(const _Float16 *in1, size_t a) {
    mfloat16m1_t m1 = mlae16_m1(in1, a);
    return mfmv_f_s(m1, a);
}

// CHECK-IR-RV64-LABEL: @test_mfmv_f_s_mfloat32_m1(
// CHECK-IR-RV64-NEXT:  entry:
// CHECK-IR-RV64-NEXT:    [[TMP0:%.*]] = bitcast float* [[IN1:%.*]] to <vscale x 32 x float>*
// CHECK-IR-RV64-NEXT:    [[TMP1:%.*]] = call <vscale x 32 x float> @llvm.riscv.mlae.m.nxv32f32.i64(<vscale x 32 x float>* [[TMP0]], i64 [[A:%.*]], i64 0) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP2:%.*]] = call float @llvm.riscv.mfmv.f.s.f32.nxv32f32.i64(<vscale x 32 x float> [[TMP1]], i64 [[A]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    ret float [[TMP2]]
//
float test_mfmv_f_s_mfloat32_m1(const float *in1, size_t a) {
    mfloat32m1_t m1 = mlae32_m1(in1, a);
    return mfmv_f_s(m1, a);
}

// CHECK-IR-RV64-LABEL: @test_mfmv_f_s_mfloat64_m1(
// CHECK-IR-RV64-NEXT:  entry:
// CHECK-IR-RV64-NEXT:    [[TMP0:%.*]] = bitcast double* [[IN1:%.*]] to <vscale x 16 x double>*
// CHECK-IR-RV64-NEXT:    [[TMP1:%.*]] = call <vscale x 16 x double> @llvm.riscv.mlae.m.nxv16f64.i64(<vscale x 16 x double>* [[TMP0]], i64 [[A:%.*]], i64 0) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP2:%.*]] = call double @llvm.riscv.mfmv.f.s.f64.nxv16f64.i64(<vscale x 16 x double> [[TMP1]], i64 [[A]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    ret double [[TMP2]]
//
double test_mfmv_f_s_mfloat64_m1(const double *in1, size_t a) {
    mfloat64m1_t m1 = mlae64_m1(in1, a);
    return mfmv_f_s(m1, a);
}
