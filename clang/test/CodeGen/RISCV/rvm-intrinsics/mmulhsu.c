...
// CHECK-IR-RV64-LABEL: @test_mmulhsu_mm_uint8m1(
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 128 x i8> @llvm.riscv.mmulhsu.mm.nxv128i8(<vscale x 128 x i8> [[TMP1]], <vscale x 128 x i8> [[TMP3]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP5:%.*]] = call <vscale x 128 x i8> @llvm.riscv.mmulhsu.b.mm.nxv128i8(<vscale x 128 x i8> [[TMP4]], <vscale x 128 x i8> [[TMP3]]) #[[ATTR4]]
...
//
void test_mmulhsu_mm_uint8m1(const uint8_t *in1, const uint8_t *in2, uint8_t *out, size_t a) {
    muint8_t m1 = mlc_m(in1, a);
    muint8_t m2 = mlc_m(in2, a);
    muint8_t mo = mmulhsu_mm(m1, m2);
    mo = mmulhsu_b_mm(mo, m2);
    msc_m(mo, out, a);
    return;
}

// CHECK-IR-RV64-LABEL: @test_mmulhsu_mm_uint16m1(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 64 x i16> @llvm.riscv.mmulhsu.mm.nxv64i16(<vscale x 64 x i16> [[TMP1]], <vscale x 64 x i16> [[TMP3]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP5:%.*]] = call <vscale x 64 x i16> @llvm.riscv.mmulhsu.h.mm.nxv64i16(<vscale x 64 x i16> [[TMP4]], <vscale x 64 x i16> [[TMP3]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mmulhsu_mm_uint16m1(const uint16_t *in1, const uint16_t *in2, uint16_t *out, size_t a) {
    muint16_t m1 = mlc_m(in1, a);
    muint16_t m2 = mlc_m(in2, a);
    muint16_t mo = mmulhsu_mm(m1, m2);
    mo = mmulhsu_h_mm(mo, m2);
    msc_m(mo, out, a);
    return;
}

// CHECK-IR-RV64-LABEL: @test_mmulhsu_mm_uint32m1(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 32 x i32> @llvm.riscv.mmulhsu.mm.nxv32i32(<vscale x 32 x i32> [[TMP1]], <vscale x 32 x i32> [[TMP3]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP5:%.*]] = call <vscale x 32 x i32> @llvm.riscv.mmulhsu.w.mm.nxv32i32(<vscale x 32 x i32> [[TMP4]], <vscale x 32 x i32> [[TMP3]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mmulhsu_mm_uint32m1(const uint32_t *in1, const uint32_t *in2, uint32_t *out, size_t a) {
    muint32_t m1 = mlc_m(in1, a);
    muint32_t m2 = mlc_m(in2, a);
    muint32_t mo = mmulhsu_mm(m1, m2);
    mo = mmulhsu_w_mm(mo, m2);
    msc_m(mo, out, a);
    return;
}

// CHECK-IR-RV64-LABEL: @test_mmulhsu_mm_uint64m1(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 16 x i64> @llvm.riscv.mmulhsu.mm.nxv16i64(<vscale x 16 x i64> [[TMP1]], <vscale x 16 x i64> [[TMP3]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP5:%.*]] = call <vscale x 16 x i64> @llvm.riscv.mmulhsu.dw.mm.nxv16i64(<vscale x 16 x i64> [[TMP4]], <vscale x 16 x i64> [[TMP3]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mmulhsu_mm_uint64m1(const uint64_t *in1, const uint64_t *in2, uint64_t *out, size_t a) {
    muint64_t m1 = mlc_m(in1, a);
    muint64_t m2 = mlc_m(in2, a);
    muint64_t mo = mmulhsu_mm(m1, m2);
    mo = mmulhsu_dw_mm(mo, m2);
    msc_m(mo, out, a);
    return;
}
