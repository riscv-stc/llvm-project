...
// CHECK-IR-RV64-LABEL: @test_mwmau_uint32(
...
// CHECK-IR-RV64-NEXT:    [[TMP6:%.*]] = call <vscale x 32 x i32> @llvm.riscv.mwmau.mm.nxv32i32.nxv64i16(<vscale x 32 x i32> [[TMP5]], <vscale x 64 x i16> [[TMP1]], <vscale x 64 x i16> [[TMP3]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP7:%.*]] = call <vscale x 32 x i32> @llvm.riscv.mwmau.h.mm.nxv32i32.nxv64i16(<vscale x 32 x i32> [[TMP6]], <vscale x 64 x i16> [[TMP1]], <vscale x 64 x i16> [[TMP3]]) #[[ATTR4]]
...
//
void test_mwmau_uint32(const uint32_t *dest, const uint16_t *in1,
    ...
    d_m = mwmau_h_mm(d_m, m1, m2);
    msc_m(d_m, dest, a);
    return;
}

// CHECK-IR-RV64-LABEL: @test_mwmau_uint64(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP6:%.*]] = call <vscale x 16 x i64> @llvm.riscv.mwmau.mm.nxv16i64.nxv32i32(<vscale x 16 x i64> [[TMP5]], <vscale x 32 x i32> [[TMP1]], <vscale x 32 x i32> [[TMP3]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP7:%.*]] = call <vscale x 16 x i64> @llvm.riscv.mwmau.w.mm.nxv16i64.nxv32i32(<vscale x 16 x i64> [[TMP6]], <vscale x 32 x i32> [[TMP1]], <vscale x 32 x i32> [[TMP3]]) #[[ATTR4]]
...
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mwmau_uint64(const uint64_t *dest, const uint32_t *in1,
                       const uint32_t *in2, size_t a) {
    muint32_t m1 = mla_m(in1, a);
    muint32_t m2 = mla_m(in2, a);
    muint64_t d_m = mlc_m(dest, a);
    d_m = mwmau_mm(d_m, m1, m2);
    d_m = mwmau_w_mm(d_m, m1, m2);
    msc_m(d_m, dest, a);
    return;
}

// CHECK-IR-RV64-LABEL: @test_mqmau_uint32(
// CHECK-IR-RV64-NEXT:  entry:
...
// CHECK-IR-RV64-NEXT:    [[TMP4:%.*]] = bitcast i32* [[DEST:%.*]] to <vscale x 32 x i32>*
// CHECK-IR-RV64-NEXT:    [[TMP5:%.*]] = call <vscale x 32 x i32> @llvm.riscv.mlc.m.nxv32i32.i64(<vscale x 32 x i32>* [[TMP4]], i64 [[A]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP6:%.*]] = call <vscale x 32 x i32> @llvm.riscv.mqmau.mm.nxv32i32.nxv128i8(<vscale x 32 x i32> [[TMP5]], <vscale x 128 x i8> [[TMP1]], <vscale x 128 x i8> [[TMP3]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP7:%.*]] = call <vscale x 32 x i32> @llvm.riscv.mqmau.b.mm.nxv32i32.nxv128i8(<vscale x 32 x i32> [[TMP6]], <vscale x 128 x i8> [[TMP1]], <vscale x 128 x i8> [[TMP3]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    [[TMP8:%.*]] = bitcast i32* [[DEST]] to <vscale x 32 x i32>*
// CHECK-IR-RV64-NEXT:    call void @llvm.riscv.msc.m.nxv32i32.i64(<vscale x 32 x i32> [[TMP7]], <vscale x 32 x i32>* [[TMP8]], i64 [[A]]) #[[ATTR4]]
// CHECK-IR-RV64-NEXT:    ret void
//
void test_mqmau_uint32(const uint32_t *dest, const uint8_t *in1,
                       const uint8_t *in2, size_t a) {
    muint8_t m1 = mla_m(in1, a);
    muint8_t m2 = mla_m(in2, a);
    muint32_t d_m = mlc_m(dest, a);
    d_m = mqmau_mm(d_m, m1, m2);
    d_m = mqmau_b_mm(d_m, m1, m2);
    msc_m(d_m, dest, a);
    return;
}
