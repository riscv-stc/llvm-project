...
static void test_maxpool2d3() {
  float src[] = {-0.2103, -0.2210, -1.4064, -1.1645, -1.0232, -0.2137, -0.4982, -1.2809,
  ...
  float ans[] = {1.6452, 0.8780, 1.3560, 1.6891, 0.7801, 2.5031, 1.6452, 1.2846, 1.3560,
        1.6891, 1.5560, 2.5031, 1.6452, 1.2846, 1.3560, 1.6891, 1.5560, 0.7530,
        1.6452, 1.3695, 1.3560, 1.6891, 1.0441, 2.5031, 1.6452, 1.3695, 1.3560,
        1.6891, 1.5560, 2.5031, 1.6452, 1.3695, 1.3560, 1.6891, 1.5560, 1.2795,
        1.6452, 1.3695, 1.3560, 1.6891, 1.0441, 2.5031, 1.6452, 1.3695, 1.3560,
        1.6891, 1.5560, 2.5031, 1.6452, 1.3695, 1.3560, 1.6891, 1.5560, 1.2795};
  const int B = 1;
  const int C = 6;
