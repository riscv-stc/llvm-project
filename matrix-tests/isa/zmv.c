...
static void test_mmvar_v_m() {
  ...
  msettileki(16);
  vsetvl_e8m1(2 * 16);
  mint8m2_t i8_m2 = mlae8_m2(i8_src_m2, 16 * sizeof(int8_t));
  vint8m2_t i8_v2 = mmvar_v_m(i8_m2, 0);
  msae8_v(i8_v2, i8_buffer, 16 * sizeof(int8_t));
  vse8(i8_buffer, i8_v2, 0);
  EXCEPT_I8_ARRAY_EQ(i8_src_m2, i8_buffer, 2 * 16, "MMVAR.V.M INT8   M2");
  // // uint8
  // msettype(E8, M1, BA);
  // msettilemi(3);
  // msettileki(4);
  ...
  // vuint8m1_t u8_v1 = mmvar_v_m(u8_m1, 0);
  // msae8_v(u8_v1, u8_buffer, 4 * sizeof(int8_t));
  // EXCEPT_U8_ARRAY_EQ(i8_src, i8_buffer, 12, "MMVAR.V.M UINT8  M2");
  // // int16
  // msettype(E16, M1, BA);
  // msettilemi(3);
  // msettileki(8);
