...
declare <vscale x 128 x i16> @llvm.riscv.mswma.mm.nxv8i16.nxv8i8.nxv8i8.nxv8i16(
  <vscale x 128 x i16>,
  <vscale x 128 x i8>,
  <vscale x 128 x i8>)

declare <vscale x 64 x i32> @llvm.riscv.mswma.mm.nxv4i32.nxv4i16.nxv4i16.nxv4i32(
  <vscale x 64 x i32>,
  <vscale x 64 x i16>,
  <vscale x 64 x i16>)

declare <vscale x 32 x i64> @llvm.riscv.mswma.mm.nxv2i64.nxv2i32.nxv2i32.nxv2i64(
  <vscale x 32 x i64>,
  <vscale x 32 x i32>,
  <vscale x 32 x i32>)


define void @intrinsic_mlae_mswma_mm_msae_i8(<vscale x 128 x i8>* %0, <vscale x 128 x i8>* %1, <vscale x 128 x i16>* %2, i64 %3, i64 %4) nounwind {
; CHECK-LABEL: intrinsic_mlae_mswma_mm_msae_i8:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    mlae8.m tr0, (a0), a3, m1
; CHECK-NEXT:    mlae8.m tr1, (a1), a3, m1
; CHECK-NEXT:    mlae16.m tr2, (a2), a3, m2
; CHECK-NEXT:    mswma.mm tr2, tr0, tr1
...
entry:
  ...
  %8 = call <vscale x 128 x i16> @llvm.riscv.mswma.mm.nxv8i16.nxv8i8.nxv8i8.nxv8i16(
...
define void @intrinsic_mlae_mswma_mm_msae_i16(<vscale x 64 x i16>* %0, <vscale x 64 x i16>* %1, <vscale x 64 x i32>* %2, i64 %3, i64 %4) nounwind {
; CHECK-LABEL: intrinsic_mlae_mswma_mm_msae_i16:
; CHECK:       # %bb.0: # %entry
...
entry:
  ...
  %8 = call <vscale x 64 x i32> @llvm.riscv.mswma.mm.nxv4i32.nxv4i16.nxv4i16.nxv4i32(
    <vscale x 64 x i32> %7,
    <vscale x 64 x i16> %5,
    <vscale x 64 x i16> %6)
...
define void @intrinsic_mlae_mswma_mm_msae_i32(<vscale x 32 x i32>* %0, <vscale x 32 x i32>* %1, <vscale x 32 x i64>* %2, i64 %3, i64 %4) nounwind {
; CHECK-LABEL: intrinsic_mlae_mswma_mm_msae_i32:
; CHECK:       # %bb.0: # %entry
...
entry:
  ...
  %8 = call <vscale x 32 x i64> @llvm.riscv.mswma.mm.nxv2i64.nxv2i32.nxv2i32.nxv2i64(
    <vscale x 32 x i64> %7,
    <vscale x 32 x i32> %5,
    <vscale x 32 x i32> %6)
