...
declare <vscale x 64 x half> @llvm.riscv.mfmin.mm.nxv4f16(
  <vscale x 64 x half>,
  <vscale x 64 x half>,
  i64)

declare <vscale x 32 x float> @llvm.riscv.mfmin.mm.nxv2f32(
  <vscale x 32 x float>,
  <vscale x 32 x float>,
  i64)

declare <vscale x 16 x double> @llvm.riscv.mfmin.mm.nxv1f64(
  <vscale x 16 x double>,
  <vscale x 16 x double>,
  i64)

define void @intrinsic_mlae_mfmin64_msae(<vscale x 16 x double>* %0, <vscale x 16 x double>* %1, i64 %2, i64 %3) nounwind {
; CHECK-LABEL: intrinsic_mlae_mfmin64_msae:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    mlae64.m tr0, (a0), a2, m1
; CHECK-NEXT:    mlae64.m tr1, (a1), a2, m1
; CHECK-NEXT:    mfmin.mm tr0, tr0, tr1, m1
...
entry:
  ...
  %6 = call <vscale x 16 x double> @llvm.riscv.mfmin.mm.nxv1f64(
...
define void @intrinsic_mlae_mfmin32_msae(<vscale x 32 x float>* %0, <vscale x 32 x float>* %1, i64 %2, i64 %3) nounwind {
; CHECK-LABEL: intrinsic_mlae_mfmin32_msae:
; CHECK:       # %bb.0: # %entry
...
entry:
  ...
  %6 = call <vscale x 32 x float> @llvm.riscv.mfmin.mm.nxv2f32(
...
define void @intrinsic_mlae_mfmin16_msae(<vscale x 64 x half>* %0, <vscale x 64 x half>* %1, i64 %2, i64 %3) nounwind {
; CHECK-LABEL: intrinsic_mlae_mfmin16_msae:
; CHECK:       # %bb.0: # %entry
...
entry:
  ...
  %6 = call <vscale x 64 x half> @llvm.riscv.mfmin.mm.nxv4f16(
