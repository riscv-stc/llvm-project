...
declare <vscale x 128 x i16> @llvm.riscv.mwmulu.mm.nxv8i8.nxv8i8.nxv8i16(
  <vscale x 128 x i8>,
  <vscale x 128 x i8>,
  i64)

declare <vscale x 64 x i32> @llvm.riscv.mwmulu.mm.nxv4i16.nxv4i16.nxv4i32(
  <vscale x 64 x i16>,
  <vscale x 64 x i16>,
  i64)

declare <vscale x 32 x i64> @llvm.riscv.mwmulu.mm.nxv2i32.nxv2i32.nxv2i64(
  <vscale x 32 x i32>,
  <vscale x 32 x i32>,
  i64)


define void @intrinsic_mlae_mwmulu_mm_msae_i8(<vscale x 128 x i8>* %0, <vscale x 128 x i8>* %1, <vscale x 128 x i16>* %2, i64 %3, i64 %4) nounwind {
; CHECK-LABEL: intrinsic_mlae_mwmulu_mm_msae_i8:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    mlae8.m tr0, (a0), a3, m1
; CHECK-NEXT:    mlae8.m tr1, (a1), a3, m1
; CHECK-NEXT:    mwmulu.mm tr0, tr0, tr1, m1
...
entry:
  ...
  %7 = call <vscale x 128 x i16> @llvm.riscv.mwmulu.mm.nxv8i8.nxv8i8.nxv8i16(
    <vscale x 128 x i8> %5,
    <vscale x 128 x i8> %6,
    i64 0)
...
define void @intrinsic_mlae_mwmulu_mm_msae_i16(<vscale x 64 x i16>* %0, <vscale x 64 x i16>* %1, <vscale x 64 x i32>* %2, i64 %3, i64 %4) nounwind {
; CHECK-LABEL: intrinsic_mlae_mwmulu_mm_msae_i16:
; CHECK:       # %bb.0: # %entry
...
entry:
  ...
  %7 = call <vscale x 64 x i32> @llvm.riscv.mwmulu.mm.nxv4i16.nxv4i16.nxv4i32(
    <vscale x 64 x i16> %5,
    <vscale x 64 x i16> %6,
    i64 0)
...
define void @intrinsic_mlae_mwmulu_mm_msae_i32(<vscale x 32 x i32>* %0, <vscale x 32 x i32>* %1, <vscale x 32 x i64>* %2, i64 %3, i64 %4) nounwind {
; CHECK-LABEL: intrinsic_mlae_mwmulu_mm_msae_i32:
; CHECK:       # %bb.0: # %entry
...
entry:
  ...
  %7 = call <vscale x 32 x i64> @llvm.riscv.mwmulu.mm.nxv2i32.nxv2i32.nxv2i64(
    <vscale x 32 x i32> %5,
    <vscale x 32 x i32> %6,
    i64 0)
