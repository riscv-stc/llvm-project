...
declare <vscale x 128 x i32> @llvm.riscv.msqmau.mm.nxv8i32.nxv8i8.nxv8i8.nxv8i32(
  <vscale x 128 x i32>,
  <vscale x 128 x i8>,
  <vscale x 128 x i8>)

declare <vscale x 64 x i64> @llvm.riscv.msqmau.mm.nxv4i64.nxv4i16.nxv4i16.nxv4i64(
  <vscale x 64 x i64>,
  <vscale x 64 x i16>,
  <vscale x 64 x i16>)


define void @intrinsic_mlae_msqmau_mm_msae_i8(<vscale x 128 x i8>* %0, <vscale x 128 x i8>* %1, <vscale x 128 x i32>* %2, i64 %3, i64 %4) nounwind {
; CHECK-LABEL: intrinsic_mlae_msqmau_mm_msae_i8:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    mlae8.m tr0, (a0), a3, m1
; CHECK-NEXT:    mlae8.m tr1, (a1), a3, m1
; CHECK-NEXT:    mlae32.m tr4, (a2), a3, m4
; CHECK-NEXT:    msqmau.mm tr4, tr0, tr1
; CHECK-NEXT:    msae32.m tr4, (a2), a3, m4
; CHECK-NEXT:    ret
entry:
  ...
  %7 = call <vscale x 128 x i32> @llvm.riscv.mlae.m.nxv8i32(
    <vscale x 128 x i32>* %2,
    i64 %3, i64 2)

  %8 = call <vscale x 128 x i32> @llvm.riscv.msqmau.mm.nxv8i32.nxv8i8.nxv8i8.nxv8i32(
    <vscale x 128 x i32> %7,
    <vscale x 128 x i8> %5,
    <vscale x 128 x i8> %6)

  call void @llvm.riscv.msae.m.nxv8i32(
...
define void @intrinsic_mlae_msqmau_mm_msae_i16(<vscale x 64 x i16>* %0, <vscale x 64 x i16>* %1, <vscale x 64 x i64>* %2, i64 %3, i64 %4) nounwind {
; CHECK-LABEL: intrinsic_mlae_msqmau_mm_msae_i16:
; CHECK:       # %bb.0: # %entry
...
entry:
  ...
  %7 = call <vscale x 64 x i64> @llvm.riscv.mlae.m.nxv4i64(
    <vscale x 64 x i64>* %2,
    i64 %3, i64 2)

  %8 = call <vscale x 64 x i64> @llvm.riscv.msqmau.mm.nxv4i64.nxv4i16.nxv4i16.nxv4i64(
    <vscale x 64 x i64> %7,
    <vscale x 64 x i16> %5,
    <vscale x 64 x i16> %6)

  call void @llvm.riscv.msae.m.nxv4i64(
    <vscale x 64 x i64> %8,
    <vscale x 64 x i64>* %2,
    i64 %3, i64 2)
