...
declare <vscale x 128 x i8> @llvm.riscv.mand.mm.nxv128i8(
  <vscale x 128 x i8>,
  <vscale x 128 x i8>
)

define void @intrinsic_mand_mm_nxv128i8(<vscale x 128 x i8>* %0, <vscale x 128 x i8>* %1, i64 %2) nounwind {
; CHECK-LABEL: intrinsic_mand_mm_nxv128i8:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    mlce8.m acc0, (a0), a2
; CHECK-NEXT:    mlce8.m acc1, (a1), a2
; CHECK-NEXT:    mand.mm acc0, acc0, acc1
...
entry:
  ...
  %5 = call <vscale x 128 x i8> @llvm.riscv.mand.mm.nxv128i8(
    <vscale x 128 x i8> %3,
    <vscale x 128 x i8> %4
  )
...
declare <vscale x 64 x i16> @llvm.riscv.mand.mm.nxv64i16(
  <vscale x 64 x i16>,
  <vscale x 64 x i16>
)

define void @intrinsic_mand_mm_nxv64i16(<vscale x 64 x i16>* %0, <vscale x 64 x i16>* %1, i64 %2) nounwind {
; CHECK-LABEL: intrinsic_mand_mm_nxv64i16:
; CHECK:       # %bb.0: # %entry
...
entry:
  ...
  %5 = call <vscale x 64 x i16> @llvm.riscv.mand.mm.nxv64i16(
    <vscale x 64 x i16> %3,
    <vscale x 64 x i16> %4
  )
...
declare <vscale x 32 x i32> @llvm.riscv.mand.mm.nxv32i32(
  <vscale x 32 x i32>,
  <vscale x 32 x i32>
)

define void @intrinsic_mand_mm_nxv32i32(<vscale x 32 x i32>* %0, <vscale x 32 x i32>* %1, i64 %2) nounwind {
; CHECK-LABEL: intrinsic_mand_mm_nxv32i32:
; CHECK:       # %bb.0: # %entry
...
entry:
  ...
  %5 = call <vscale x 32 x i32> @llvm.riscv.mand.mm.nxv32i32(
    <vscale x 32 x i32> %3,
    <vscale x 32 x i32> %4
  )
...
declare <vscale x 16 x i64> @llvm.riscv.mand.mm.nxv16i64(
  <vscale x 16 x i64>,
  <vscale x 16 x i64>
)

define void @intrinsic_mand_mm_nxv16i64(<vscale x 16 x i64>* %0, <vscale x 16 x i64>* %1, i64 %2) nounwind {
; CHECK-LABEL: intrinsic_mand_mm_nxv16i64:
; CHECK:       # %bb.0: # %entry
...
entry:
  ...
  %5 = call <vscale x 16 x i64> @llvm.riscv.mand.mm.nxv16i64(
    <vscale x 16 x i64> %3,
    <vscale x 16 x i64> %4
  )
